                    ...
                    */
                    ...
                    for (let i = 0; i < linodes.length; i++) {
                        linodes[i].addEventListener('click', function () {
                            let idx = i
                            bigimgidx = idx//储存点击的小图下标--改变大图片的路径
                            smallimg.src = imagessrccc[idx].s//改变小图片的路径
                        })
                    }
                }
                //点击缩略图左右箭头效果
            ...
            */
            ...
            for (let i = 0; i < crumbData.length; i++) {
                ...
                for (let j = 0; j < crumbData[i].data.length; j++) {
                    ...
                    ddnode.setAttribute('price', crumbData[i].data[j].changePrice)//添加css属性
